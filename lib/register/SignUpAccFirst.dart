...
class SignUpAccFirst extends StatefulWidget {
  final PageController pageController;

  SignUpAccFirst({required this.pageController});

  @override
  _SignUpAccFirstState createState() => _SignUpAccFirstState();
}

class _SignUpAccFirstState extends State<SignUpAccFirst> {
